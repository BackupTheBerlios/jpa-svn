...
from archviewdialog_impl import ArchViewDialogImpl

class ArchViewDialog(ArchViewDialogImpl):

    def __init__(self, fileName, parent=None, name=None, fl=0):
        ArchViewDialogImpl.__init__(self, parent, name, fl)
        self.setFocusProxy(self.lbxMessages)
